...
import com.charann.InventoryManagementSystem.entity.WeightUnit;
import com.charann.InventoryManagementSystem.repository.ProductBoughtRepo;
import com.charann.InventoryManagementSystem.service.ProductBoughtService;
...
//    }
    ...
    public ProductBought updateProduct(@PathVariable long id, @RequestBody ProductBought productBought) {
        ...
        productBought1.setManufactureDate(productBought.getManufactureDate());
        productBought1.setProdId(productBought.getProdId());
        productBought1.setSerialNo(productBought.getSerialNo());
        productBought1.setLotNo(productBought.getLotNo());
        productBought1.setWarehouseArrivingDate(productBought.getWarehouseArrivingDate());
